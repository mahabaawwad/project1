...
public class ShowPlanetsFragment extends Fragment {
     public FirebaseServices fbs;
     public ArrayList<Planet>rests;
    ...
    public void onStart() {
        ...
        rests = new ArrayList<>();
        fbs.getFire().collection("Planet").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            @Override
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Log.e("AllPlanetFragment", e.getMessage());
            }
        });
    }
}