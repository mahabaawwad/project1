...
public class AddPlanetFragment extends Fragment {
    ...
    private void connectComponents() {
        ...
        etOrbit=getView().findViewById(R.id.etOrbitAddFrangment);
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (name.trim().isEmpty()||size.isEmpty()|| orbit.trim().isEmpty())
                {
                    Toast.makeText(getActivity(), "some fields are empty! ", Toast.LENGTH_SHORT).show();
                    return;
                }

                Planet rest= new Planet(name,size,orbit);

                fbs.getFire().collection("planet").add(rest).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                    @Override
